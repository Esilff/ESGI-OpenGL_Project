<<<<<<< Updated upstream:src/core/math/math.cpp
#include "math.h"
=======
#include "quaternion.h"
>>>>>>> Stashed changes:src/core/math/quaternion.cpp
#include <math.h>
...
void Quaternion::quaternionToMatrix(float* matrix) {
